  ...
  const testimonials = [
    {
      ...
      company: 'ABC Fashion',
      content: 'ใช้ MarketPro มา 2 ปีแล้ว ยอดขายเพิ่มขึ้น 250% ระบบใช้งานง่าย ทีมซัพพอร์ตดีมาก ตอบเร็วทุกครั้ง',
      rating: 5,
      image: '👨‍💼'
    },
    {
    ...
    },
    {
      ...
      position: 'Owner',
      company: 'Café Sweet',
      content: 'ร้านเล็กๆ อย่างเราก็ใช้ได้ ราคาไม่แพง ฟีเจอร์ครบ ลูกค้าประจำเพิ่มขึ้นเยอะ ขอบคุณ MarketPro ครับ',
      rating: 5,
      image: '☕'
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            ฟังเสียงจากลูกค้าจริงที่ใช้ MarketPro 
        ...
        <div className="text-center mt-16">
          <div className="bg-card rounded-2xl p-6 md:p-8 lg:p-12 shadow-professional border">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              เข้าร่วมกับธุรกิจมากกว่า 50,000 แห่งที่เลือกใช้ MarketPro 
